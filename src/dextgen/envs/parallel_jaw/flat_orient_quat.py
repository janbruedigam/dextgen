...
from dextgen.envs.rotations import embedding2mat, embedding2quat, fastembedding2quat, euler2quat, vec2quat
...
class FlatPJOrientQuat(FlatPJBase, utils.EzPickle):
    """FlatPJOrientQuat environment class."""
